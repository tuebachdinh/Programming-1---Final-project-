...
class Prison_Escape:
 ...
 /** Round 3 */
  ...
  this.world.addAccessibleRooms(Buffer[Room](this.prison))
  ...
  this.room_7.addInformationOfNPC("Personality", "You are a caring and protective partner who is supportive, dedicated, and hardworking."
   + "\nYou are also sometimes possessive and introverted, which always lead to moments of tension.")
  ...
  this.room_7.addInformationOfNPC("Past","You had a difficult upbringing and achieved academic success. " +
    ...
    "\nwith moments of intense love and doubt, particularly as I developed a close friendship with John")
  ...
  val finalAnswer =
    "\n------- Behind Story -------" +
    "\n\n  Amidst a labyrinth of memories, you are Toby, a vibrant art history graduate turned museum secretary, " +
    "\nunraveled a life intricately woven with ambition, love, envy, and betrayal. Academic excellence and" +
    "\nan evolving romance with Julia defined a period marked by financial strains. " +
    "\n\n  Toby's tenure at the museum under Director John intensified a blend of admiration and jealousy " +
    "\nwithin their relationship. As Julia's bond with John deepened, complexities arose, oscillating between" +
    "\naffection and doubt. Fragments of conversation hinted at Toby's involvement in acquiring Kali Cyanide, " +
    "\nto kill director John, then becoming the new director. Both love and money are the behind motivation." +
    "\n\n  Within the prison's confines, " + "Toby's pursuit of freedom and forgotten memories portrayed a poignant " +
    "\nexploration of human emotions. Each interaction and space contributed to reconstructing the past, prompting" +
    "\nintrospection and a quest for redemption. Toby's journey depicted the intricate dance between personal choices " +
    "\nand interpersonal relationships, whether seeking liberation or grappling with guilt, urging contemplation on " +
    "\nthe enduring consequences of actions."
