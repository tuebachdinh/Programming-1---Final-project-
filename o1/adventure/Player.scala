...
/** A `Player` object represents a player character controlled by the real-life user
  * of the program. A player object’s state is mutable: the player’s location and 
  * possessions can change.
  *
...
class Player(startingRoom: Room):
  ...
  /** Return the behind story of the room if the player chooses to elaborate */
